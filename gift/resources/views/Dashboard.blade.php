                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/radhe.png" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="{{ url('edit-profile') }}"><i class="fa fa-user"></i> My Profile</a>

                            <a class="nav-link" href="#"><i class="fa fa-user"></i> Notifications <span
                                    class="count">13</span></a>

                            <a class="nav-link" href="#"><i class="fa fa-cog"></i> Settings</a>
                            <form action="{{ route('logout') }}" method="post" style="margin-left: -18%">
                                @csrf
                                <button class="dropdown-item" type="submit"><i class="fa fa-power-off" style="margin-right:5%"></i>Logout</button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="media">
                            <a href="#">
                                <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;"
                                    alt="" src="images/radhe.png">
                            </a>
                            <div class="media-body">
                                <h2 class="text-white pt-2 display-6">Abhi Ladani</h2>
